...
import { ArchiveAtatchmentRequestType } from "@Lib/types/backend/document-request-types";

/**
 * Validator of ArchiveAttachment
 */
export default class ArchiveAttachmentValidator
     ...
     */
    public validate(data: ArchiveAtatchmentRequestType): ActionResultType {
        return super.validateData<ArchiveAtatchmentRequestType>(this, data);
    }
}
